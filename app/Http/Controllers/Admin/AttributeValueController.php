...
class AttributeValueController extends Controller
{
    ...
    /**
     *  injecting the AttributeContract to use the findAttributeById() method.
     */
    ...
    /**
     * As you can see we loading the attribute and getting
     * the values through it’s hasMany relationship,
     * then returning them as a JSON response.
     */
